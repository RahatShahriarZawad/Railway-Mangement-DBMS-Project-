...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="row">
    <div class="col-25">
      <label for="t_amount">Ticket amount</label>
    </div>
    <div class="col-75">
      <input type="text" id="t_amount" name="t_amount" placeholder="enter ticket amount...">
    </div>
  </div>
  
  <div class="row">
  <div class="col-25">
      <label for="t_amount">Ticket type</label>
    </div>
    <div class="col-75">
  ...
  <div class="row">
<input type='button' onclick='ajaxFunction()' value='Confirm Booking'/>
  </form>
<div id='ajaxDiv'>
</div>
...
function ajaxFunction(){
 ...
 var queryString = "?train_no=" + train_no ;
 queryString +=  "&username=" + username+"&email=" +email+"&t_amount=" + t_amount+"&class_type=" + class_type+"&source=" + source+"&destination=" + destination+"&date=" + date;
 ajaxRequest.open("GET", "bookingconajax.php" + queryString, true);
