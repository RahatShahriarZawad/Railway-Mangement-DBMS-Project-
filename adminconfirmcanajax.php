...
<h2>Confirm Ticket cancel Request</h2>
...
<div class="container">
  ...
  <div class="row">
<input type='button' onclick='ajaxFunction()' value='confirm cancellation'/>
<div id='ajaxDiv'>
</div>
...
function ajaxFunction(){
 ...
 var queryString = "?ticket_no=" + ticket_no ;
 ajaxRequest.open("GET", "cancelconajax.php" + queryString, true);
