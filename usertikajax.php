...
<div class="container">
  ...
  <div class="row">
    <input type='button' onclick='ajaxFunction()' value='Check Booking'/>
  </div>
  </form>
...
function ajaxFunction(){
 ...
 queryString +=  "&email=" + email+"&train_no=" + train_no;
 ajaxRequest.open("GET", "usertikshowajax.php" + queryString, true);
