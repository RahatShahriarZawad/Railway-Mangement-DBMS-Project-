...
echo "<tr><td>" . $row["ticket_no"]. "</td><td>" . $row["train_no"] . "</td><td>" . $row["username"] . "</td><td>" . $row["email"] . "</td>
<td>" . $row["fare"] . "</td><td>" . $row["t_amount"] . "</td>
<td>" . $row["class_type"] . "</td><td>" . $row["source"] . "</td><td>" . $row["destination"] . "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
