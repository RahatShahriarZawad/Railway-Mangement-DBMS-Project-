...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="train_no" name="train_no" placeholder="enter train no...">
    </div>
  </div> 
 <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="fare" name="fare" placeholder="new fare in tk">
    </div>
  </div>  
  
  <div class="row">
<input type='button' onclick='ajaxFunction()' value='update fare'/>
<div id='ajaxDiv'>
</div>
...
function ajaxFunction(){
 ...
 // server script.var email = document.getElementById('email').value;
 ...
 queryString +=  "&class_type=" +class_type+"&fare=" + fare;
 
 ajaxRequest.open("GET", "fareupajax.php" + queryString, true);
